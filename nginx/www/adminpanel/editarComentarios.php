<?php
session_start();
// Pagina para editar los comentarios desde el apartado de administrador 
// Consulta de los atributos del comentario donde el usuario comentó  y actualización como los nuevos cambios
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE comentarios SET opinion = ? WHERE id_comentarios = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('si', $opinion, $id);
    $stmt->execute();
...
<div class="sticky-top">
    ...
    <div class="centrar">
        <div class="titulo">Editar Comentario</div>
      
        <form method="POST" class="formulario">
            <input type="hidden" name="id" value="<?php echo $comentario['id_comentarios']; ?>">
            <label>Opinion:</label>
            <textarea name="opinion"  class="mt-2"><?php echo htmlspecialchars($comentario['opinion']); ?></textarea>
