<?php
session_start();
// Codigo para insertar entradas como administrador
    ...
    else 
    {
        ...
        if ($_FILES["imagen"]["error"] == UPLOAD_ERR_OK) 
        {
            ...
            else 
            {
                ...
                $ruta_imagen = "../fotosEntradas/" ."ad_".$usuario."_". $nombre_imagen;
        ...
        if (!isset($error)) 
        {
            $stmt = $conn->prepare("INSERT INTO entradas (titulo, imagenEntrada, descripcion, nombre_admin, fechaCreacionEntrada) VALUES (?, ?, ?, ?, NOW())");
