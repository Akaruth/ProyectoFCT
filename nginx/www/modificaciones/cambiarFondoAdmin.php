<?php
session_start();
//  Codigo para cambiar el fondo del perfil de administrador
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    if (isset($_FILES["fondoPerfil"]) && $_FILES["fondoPerfil"]["error"] == 0) 
    {
        ...
        // Agregar el nombre de admin al nombre del archivo para evitar que se machaque a futuro
        ...
        // Mover la iumagen al sitio correspondiente
        if (move_uploaded_file($_FILES["fondoPerfil"]["tmp_name"], $rutaImagen)) 
        {
            ...
            $sql = "UPDATE adminT SET fondoPerfil='$rutaInterna' WHERE adminNick='$usuario'";
